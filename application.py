...
<head>
  ...
  <title>Welcome-virajetech.com</title>
  <style>
  body {
    color: #ffffff;
...
<body id="sample">
  <div class="textColumn">
    ...
    <p>This environment is launched with Elastic Beanstalk Python Platform - www.virajetech.com - virajetech - n bcxnnthanks hdfh ,,,</p>
  </div>
